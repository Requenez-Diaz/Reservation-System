...
const RoomAvailability: React.FC<DialogModalProps> = ({ open, onClose }) => {
    if (!open) return null;
                            ...
                            <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                ...
                                <div className="mt-2">
                                    <p className="text-sm text-gray-500">
                                        Aquí puedes mostrar la disponibilidad de la habitación para el rango de fechas seleccionado.
                                    </p>
                                    {/* Agrega aquí la información de disponibilidad según tu lógica */}
                                </div>
                            </div>
                        </div>
                    </div>
