...
export default function PropsCards({
  ...
  return (
    <Card className="group relative mx-3 mt-3 w-screen max-w-md overflow-hidden rounded-2xl border-0 bg-white shadow-lg transition-all duration-500 hover:-translate-y-3 hover:shadow-2xl">
      <Badge
      ...
      <div className="p-7">
        <CardContent className="space-y-6 p-0">
          <div className="flex items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-2 rounded-xl bg-gradient-to-r from-blue-50 to-blue-100 px-4 py-2 shadow-sm transition-all duration-300 hover:from-blue-100 hover:to-blue-200 hover:shadow-md">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-3 pt-1">
              <div className="flex items-center gap-2 rounded-xl border border-blue-200 bg-blue-50 px-4 py-2.5 transition-all duration-300 hover:border-blue-300 hover:bg-blue-100 hover:shadow-sm">
              ...
              <div className="flex items-center gap-2 rounded-xl border border-blue-200 bg-blue-50 px-4 py-2.5 transition-all duration-300 hover:border-blue-300 hover:bg-blue-100 hover:shadow-sm">
                ...
                <span className="text-sm font-semibold text-gray-800">A/C</span>
              </div>
            </div>
          </div>
        </CardContent>
