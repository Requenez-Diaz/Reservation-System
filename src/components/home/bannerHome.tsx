  ...
  return (
    <div className="relative w-full h-96">
      <Image
        ...
        width={1920}
      />
      <div className="absolute top-1/2 left-1/3 right-1 ml-4 transform -translate-x-1/2 -translate-y-1/2 bg-yellow-50 bg-opacity-70 text-white flex flex-col items-center justify-center rounded-r-2xl h-1/2 sm:lg">
