        ...
        >
                ...
                <FormControl>
                  <div className="relative">
                    <input
                      ...
                      className="w-full rounded-lg border border-stroke bg-whiteransparent py-4 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary"
                    />
              ...
              <FormItem>
                ...
                <FormControl>
                  <div className="relative">
                    <input
                      type="password"
                      placeholder="6+ caracteres con al menos un número y una letra"
                      className="w-full rounded-lg border border-stroke bg-white py-4 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary"
                    />
          ...
          <div className="mb-5 mt-4">
            <input
              ...
              className=" bg-blue-500 w-full cursor-pointer rounded-lg border border-primary p-4 text-white transition hover:bg-opacity-90"
            />
          </div>
